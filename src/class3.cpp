...
{  
    ...
    else 
    {
        ...
        gWindow = SDL_CreateWindow ( "SDL_class3", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, tela_largura, tela_altura, SDL_WINDOW_SHOWN );
        if ( gWindow == NULL ) 
        {
...
bool loadMedia() 
{
   ...
   gImage = SDL_LoadBMP ("../assets/x.bmp");
   if (gImage == NULL ) 
   {
